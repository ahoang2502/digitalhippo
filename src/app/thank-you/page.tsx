...
export const ThankYouPage = async ({ searchParams }: ThankYouPageProps) => {
	...
	return (
		<main className="relative lg:min-h-full mt-10 ">
			...
			<div className="">
				<div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
					<div className="lg:col-start-2 ">
						<p className="text-sm font-medium text-[#4b98f7]">
							Ordered successful!
						</p>

						<h1 className="font-bold tracking-tight mt-2 text-4xl text-gray-900">
							Thanks for ordering
						</h1>
						...
						{order._isPaid ? (
							...
							<p className="mt-2 text-base text-muted-foreground">
								...
								it. So hang tight and we&apos;ll send you confirmation email
								very soon!
							</p>
						)}
